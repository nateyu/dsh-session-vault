...
import { MAX_DELETE_BATCH, PLUGIN_NAME } from './config.js'
 ...
 */
export function createVaultRpcHandler(ctx) {
...
export function installVaultRpc(ctx) {
  return mountRpcChannel(ctx, PLUGIN_NAME, VAULT_RPC_CHANNEL, createVaultRpcHandler(ctx))
}
